                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 text-white animated slideInRight">Welcome to
                                        <strong>AK Advertising</strong>
                                    </p>
                                    <h1 class="display-1 text-white mb-4 animated slideInRight">Unlock Your Business
                                        Growth</h1>
                                    <a href="/services"
                                        class="btn btn-primary rounded-pill py-3 px-5 animated slideInRight">Explore our services</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <p class="fs-4 text-white animated slideInLeft">Welcome to <strong>AK Advertising</strong>
                                    </p>
                                    <h1 class="display-1 text-white mb-5 animated slideInLeft">Ready to Grow Your
                                        Business</h1>
                                    <a href="/services"
                                        class="btn btn-primary rounded-pill py-3 px-5 animated slideInLeft">Explore our services</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <h5 class="mb-3">Great Client Feedback</h5>
                        <p class="mb-0">Outstanding client feedback fuels our commitment to excellence.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Our advertising agency is distinguished by its highly professional and skilled staff.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Experience exceptional service with transparent and fair pricing at our advertising agency.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Count on our advertising agency for 24/7 support, ensuring your needs are met around the clock.</p>
                    </div>
                </div>
            </div>
        </div>
